    ...
    return (
        <div className={"contact-container " + contactStyle}>
            ...
            <form className="validate-form"> 
                ...
                <div className="flex flex-wrap justify-center pt5 form-button">
                    <a className="f4 grow no-underline br-pill ph4 pv2 dib white bg-purple">
                        <i className="material-icons mr2">send</i>
                        Submit
                    </a>
                </div>
            </form>
