    ...
    return (
        <div className="nav-container">
            <div className="flex">
                ...
                <div>
                    <a className="no-underline near-white bg-animate bg-dark-gray hover-bg-gray inline-flex items-center ma2 tc br2 pa2" href="https://github.com/fanhillary" target="_blank" rel="noopener noreferrer" title="GitHub">
                    ...
                    <a className="no-underline near-white bg-animate bg-dark-gray hover-bg-gray inline-flex items-center ma2 tc br2 pa2" href="https://www.linkedin.com/in/fanhillary/" target="_blank" rel="noopener noreferrer"  title="LinkedIn">
