    ...
    return (
        ...
        <div className="portfolio-card">
            ...
            <div className="overlay">
                ...
                <div>
                    {project['sourceLink'] ? (<a className="title-button f4 grow no-underline br-pill ba bw1 ph3 pv2 mb4 dib near-white" href={project['sourceLink']}>Source</a>) : ""} 
                    { project['demoLink'] ? (<a className="title-button f4 grow no-underline br-pill ba bw1 ph3 pv2 mb4 dib near-white" href={project['demoLink']}>Demo</a>) : ""}
                </div>
            </div>
        </div>
    )
